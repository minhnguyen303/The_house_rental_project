            ...
            <div class="row justify-content-md-center">
                <div class="col col-md-12 col-lg-12 col-xl-10">
                    ...
                    <div class="page-header bordered mb0">
                        <div class="row">
                            <div class="col-md-8"> <a href="{{route('home')}}" class="btn-return" title="Back"><i class="fa fa-angle-left"></i></a>
                                <h1>{{$house->name}} <span class="label label-bordered text-white" style="background-color: #563d7c">
                            ...
                            <div class="col-md-4">
                                <div class="price">{{ number_format($house->pricePerDay, 0, ',', '.') }}đ / ngày <small></small></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="item-gallery">
                        <div class="swiper-container gallery-top" data-pswp-uid="1">
                            <div class="swiper-wrapper lazyload">
                                ...
                                <div class="swiper-slide">
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"> <a href="{{asset('img/demo/property/1.jpg')}}" itemprop="contentUrl" data-size="2000x1414"> <img src="{{asset('img/demo/property/1.jpg')}}" class="img-fluid swiper-lazy" alt="Drawing Room"> </a> </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"> <a href="{{asset('img/demo/property/2.jpg')}}" itemprop="contentUrl" data-size="2000x1414"> <img data-src="{{asset('img/demo/property/2.jpg')}}" src="{{asset('img/spacer.png')}}" class="img-fluid swiper-lazy" alt="Drawing Room"> </a> </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"> <a href="{{asset('img/demo/property/3.jpg')}}" itemprop="contentUrl" data-size="2000x1414"> <img data-src="{{asset('img/demo/property/3.jpg')}}" src="{{asset('img/spacer.png')}}" class="img-fluid swiper-lazy" alt="Drawing Room"> </a> </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"> <a href="{{asset('img/demo/property/4.jpg')}}" itemprop="contentUrl" data-size="2000x1414"> <img data-src="{{asset('img/demo/property/4.jpg')}}" src="{{asset('img/spacer.png')}}" class="img-fluid swiper-lazy" alt="Drawing Room"> </a> </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"> <a href="{{asset('img/demo/property/5.jpg')}}" itemprop="contentUrl" data-size="2000x1414"> <img data-src="{{asset('img/demo/property/5.jpg')}}" src="{{asset('img/spacer.png')}}" class="img-fluid swiper-lazy" alt="Drawing Room"> </a> </figure>
                                </div>
                        ...
                        <div class="swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/1.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/2.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/3.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/4.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/5.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/6.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/7.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/8.jpg')}}" class="img-fluid" alt=""></div>
                                <div class="swiper-slide"><img src="{{asset('img/demo/property/thumb/9.jpg')}}" class="img-fluid" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div id="sidebar" class="sidebar-right">
                                    <div class="sidebar_inner">
                                        <div id="feature-list" role="tablist">
                                            <div class="card">
                                                <div class="card-header" role="tab" id="headingOne">
                                                    <h4 class="panel-title"> <a role="button" data-toggle="collapse" href="#specification" aria-expanded="true" aria-controls="specification"> Thông tin <i class="fa fa-caret-down float-right"></i> </a> </h4>
                                                </div>
                                                <div id="specification" class="panel-collapse collapse show" role="tabpanel">
                                                    <div class="card-body">
                                                        <table class="table v1">
                                                            ...
                                                            <tr>
                                                                <td>Giá một ngày</td>
                                                                <td>{{ number_format($house->pricePerDay, 0, ',', '.') }}<sup>đ</sup></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card shadow">
                                            ...
                                            <div class="media">
                                                <div class="media-left"> <a href="#"> <img class="media-object rounded-circle" src="{{asset('img/demo/profile.jpg')}}" width="64" height="64" alt=""> </a> </div>
                                                <div class="media-body">
                                                    <h4 class="media-heading"><a href="#">{{ (\Illuminate\Support\Facades\DB::table('users')->find($house->owner_id))->username }}</a></h4>
                                                    <p><a href="tel:01502392905"><i class="fa fa-phone" aria-hidden="true"></i> {{ (\Illuminate\Support\Facades\DB::table('users')->find($house->owner_id))->phone }}</a></p>
                                                    <p><a href="#" class="btn btn-sm btn-light">Xem thông tin</a></p>
                                                </div>
                                            </div>
                                            <a href="#" class="btn btn-lg btn-primary btn-block" data-toggle="modal" data-target="#leadform">Yêu cầu thuê nhà</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="media">
                            <div class="media-left"><img src="{{asset('img/demo/property/thumb/1.jpg')}}" width="60" class="img-rounded mt5" alt=""></div>
                            <div class="media-body">
